...
var resizePizzas = function(size) {
  ...
  //removed unnecessary action by defining variable before for loop. 
  var element1 = document.querySelectorAll(".randomPizzaContainer");
  ...
  function changePizzaSizes(size) {
    for (var i = 0; i < element1.length; i++) {
      ...
      element1[i].style.width = newwidth; 
    }
  }
...
//removed scroll calculation outside of for loop to remove unecessary calculation each time
...
//lowered the amount of pizza to 40 
